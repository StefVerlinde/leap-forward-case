...
const LeftPanel = () => {
    return (
        <div className="bg-secondary w-full rounded-2xl p-3 flex flex-col lg:max-w-[350px]">
            <div className='relative  text-sm bg-left-panel-background h-[160px] bg-cover bg-gray-800 bg-opacity-70 bg-blend-multiply rounded-t-2xl'>
                <div className="flex gap-3 p-3">
                    ...
                    <div className="flex-1 text-white bg-secondary rounded-md font-bold p-2 mx-auto border-b-[4px] border-primary border-opacity-80 flex items-center gap-3">
                        <div className='bg-background h-full flex-1 rounded-sm relative'>
                            <div className='absolute left-0 h-full w-[30%] bg-yellow-300 rounded-sm'></div>
                        </div>
                        <p className='text-center'>Level 3 / 10</p>
                    </div>
                </div>
